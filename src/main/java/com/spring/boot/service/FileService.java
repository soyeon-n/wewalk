...
public class FileService {
	...
	//첨부파일 저장하는 메소드
	//fileManager를 통해 이미지 파일과 일반 파일을 업로드 및 저장한다.
	//업로드 및 저장 처리가 완료된 첨부파일들을 넘겨준다.
	public List<UserFiles> saveAttachments(Map<AttachmentType, List<MultipartFile>> multipartFileListMap) throws IOException{
